...
class AudioClassifierHelper(
    ...
    private fun initClassifier() {
        try {
            ...
            if(runningMode == RunningMode.AUDIO_STREAM){
                optionsBuilder
                    .setResultListener(this::setAudioResultListener)
                    .setErrorListener(this::setAudioErrorListener)
            }
    ...
    private fun setAudioResultListener(resultListener: AudioClassifierResult) {
    ...
    private fun setAudioErrorListener(e: RuntimeException) {
    ...
    private fun classifyAudioAsync(audioRecord: AudioRecord) {
        ...
        val inferenceTime = android.os.SystemClock.uptimeMillis()
